...
/***/ function(module, exports, __webpack_require__) {
	...
	var renderer = PIXI.autoDetectRenderer((0, _jquery2.default)(window).width(), (0, _jquery2.default)(window).height());
	var stageContainer = new _stageContainer2.default(renderer);
	...
	function resize() {
	  var width = (0, _jquery2.default)(window).width() - 5;
	  var height = (0, _jquery2.default)(window).height() - 5;
	...
	var Particle = function () {
	  ...
	  _createClass(Particle, [{
	    ...
	    value: function updatePosition() {
	      this.position = (0, _mathUtils.getNewPosition)(this.position, this.angle, this.speed);
	    }
	  }, {
	    key: 'tick',
	    value: function tick() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getNewPosition(startPoint, angle, distance) {
	  var rads = degToRad(angle);
...
/***/ function(module, exports) {
	...
	function getRandomColor() {
	  ...
	  var _hslToRgb = hslToRgb(hue, sat, 0.7);
